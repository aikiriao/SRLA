...
CODEC_CONFUGURES = [
        ...
        SRLA("-m 0 -V 0 -B 2048"),
        SRLA("-m 0 -V 2 -B 2048"),
        SRLA("-m 0 -V 0 -B 2048 -P 3"),
        SRLA("-m 0 -V 0 -B 4096"),
        SRLA("-m 0 -V 2 -B 4096"),
        SRLA("-m 0 -V 0 -B 4096 -P 3"),
        SRLA("-m 0 -V 0 -B 8192"),
        SRLA("-m 0 -V 2 -B 8192"),
        SRLA("-m 0 -V 0 -B 8192 -P 3"),
        SRLA("-m 2 -V 0 -B 2048"),
        SRLA("-m 2 -V 2 -B 2048"),
        SRLA("-m 2 -V 0 -B 2048 -P 3"),
        SRLA("-m 2 -V 0 -B 4096"),
        SRLA("-m 2 -V 2 -B 4096"),
        SRLA("-m 2 -V 0 -B 4096 -P 3"),
        SRLA("-m 2 -V 0 -B 8192"),
        SRLA("-m 2 -V 2 -B 8192"),
        SRLA("-m 2 -V 0 -B 8192 -P 3"),
        SRLA("-m 4 -V 0 -B 2048"),
        SRLA("-m 4 -V 2 -B 2048"),
        SRLA("-m 4 -V 0 -B 2048 -P 3"),
        SRLA("-m 4 -V 0 -B 4096"),
        SRLA("-m 4 -V 2 -B 4096"),
        SRLA("-m 4 -V 0 -B 4096 -P 3"),
        SRLA("-m 4 -V 0 -B 8192"),
        SRLA("-m 4 -V 2 -B 8192"),
        SRLA("-m 4 -V 0 -B 8192 -P 3"),
        SRLA("-m 6 -V 0 -B 2048"),
        SRLA("-m 6 -V 2 -B 2048"),
        SRLA("-m 6 -V 0 -B 2048 -P 3"),
        SRLA("-m 6 -V 0 -B 4096"),
        SRLA("-m 6 -V 2 -B 4096"),
        SRLA("-m 6 -V 0 -B 4096 -P 3"),
        SRLA("-m 6 -V 0 -B 8192"),
        SRLA("-m 6 -V 2 -B 8192"),
        SRLA("-m 6 -V 0 -B 8192 -P 3"),
    ]
