...
CODEC_CONFUGURES = [
        ...
        # SRLA("-m 0 -V 1 -B 8192"),
        # SRLA("-m 0 -V 2 -B 8192"),
        # SRLA("-m 0 -V 0 -B 16384"),
        # SRLA("-m 0 -V 1 -B 16384"),
        # SRLA("-m 0 -V 2 -B 16384"),
        # SRLA("-m 2 -V 0 -B 4096"),
        # SRLA("-m 2 -V 1 -B 4096"),
        # SRLA("-m 2 -V 2 -B 4096"),
        # SRLA("-m 2 -V 0 -B 8192"),
        ...
        # SRLA("-m 4 -V 1 -B 8192"),
        # SRLA("-m 4 -V 2 -B 8192"),
        # SRLA("-m 4 -V 0 -B 16384"),
        # SRLA("-m 4 -V 1 -B 16384"),
        # SRLA("-m 4 -V 2 -B 16384"),
        # SRLA("-m 6 -V 0 -B 4096"),
        # SRLA("-m 6 -V 1 -B 4096"),
        # SRLA("-m 6 -V 2 -B 4096"),
        # SRLA("-m 6 -V 0 -B 8192"),
        # SRLA("-m 6 -V 1 -B 8192"),
        # SRLA("-m 6 -V 2 -B 8192"),
        # SRLA("-m 6 -V 0 -B 16384"),
        # SRLA("-m 6 -V 1 -B 16384"),
        # SRLA("-m 6 -V 2 -B 16384"),
    ]
